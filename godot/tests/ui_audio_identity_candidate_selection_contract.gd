...
const EXPECTED_SELECTIONS: Dictionary = {
	"ui.nav_move": ["res://audio/ui/sfx_ui_nav_move.wav", "GTA_SA:GENRL:BANK_143:SOUND_76", 44100, 1302, 2604, "aa2141c9430efe3b245ee5b44157ab077ddd89d934655fa7961ffe275e41805c", "GTA_SA:GENRL:BANK_138:SOUND_29", 44100, 840],
	"ui.nav_confirm": ["res://audio/ui/sfx_ui_nav_confirm.wav", "GTA_SA:GENRL:BANK_143:SOUND_77", 44100, 2824, 5648, "0c669ad54e911728ab16b883cc555df3067c50e29ddc2910734f4b0c93d2bf27", "GTA_SA:GENRL:BANK_143:SOUND_55", 19700, 1036],
	"ui.nav_back": ["res://audio/ui/sfx_ui_nav_back.wav", "GTA_SA:GENRL:BANK_143:SOUND_44", 18000, 623, 1246, "061b9cc26d1e6af092267fc0b949d2573c81b0d8a57dbdf772de6485539faab2", "GTA_SA:GENRL:BANK_143:SOUND_34", 22050, 1490],
	"ui.mode_switch": ["res://audio/ui/sfx_ui_mode_switch.wav", "GTA_SA:GENRL:BANK_143:SOUND_17", 23000, 1999, 3998, "1418770fc0089bf5e309c13c1efe0f275c967ae4dc5feb433b104b560d64263d", "GTA_SA:GENRL:BANK_143:SOUND_18", 23000, 2164],
	"ui.reject": ["res://audio/ui/sfx_ui_reject.wav", "GTA_SA:GENRL:BANK_143:SOUND_4", 22000, 2143, 4286, "04964bf39958d7a8489e05a177de7a36c466415b121524e3584043d01f0b09f5", "GTA_SA:GENRL:BANK_143:SOUND_71", 17600, 1711],
	"ui.radio_station_step": ["res://audio/ui/sfx_ui_radio_step.wav", "GTA_SA:GENRL:BANK_143:SOUND_47", 24000, 2381, 4762, "283cd247c21b3e3e6f05fab00d2aaf843bbbc87e6a8ba87569023894cc5e9d2f", "GTA_SA:GENRL:BANK_143:SOUND_50", 16000, 1589],
	"ui.replay_retry_confirm": ["res://audio/ui/sfx_ui_replay_retry_confirm.wav", "GTA_SA:GENRL:BANK_143:SOUND_73", 26000, 2697, 5394, "eaff3fbad94ab16329f976307d94b6220452f4933cca4d847d67ed68afdf3c02", "GTA_SA:GENRL:BANK_143:SOUND_84", 22400, 2975],
}
...
static func verify(manager: Node, layer: Node) -> String:
	...
	for slot_id in expected_slots:
		...
		or String(selection.get("raw_pcm_sha256", "")) != String(expected[5]) \
		or String(selection.get("runner_up_provenance", "")) != String(expected[6]) \
		or int(selection.get("runner_up_sample_rate_hz", 0)) != int(expected[7]) \
		or int(selection.get("runner_up_frames", 0)) != int(expected[8]):
